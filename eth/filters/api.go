...
// can hold additonal information about the logs such as whether it was deleted.
// Additonally when nil is given it will by default instead create an empty slice
...
func toRPCLogs(logs vm.Logs, removed bool) []vmlog {
	...
	for i, log := range logs {
		convertedLogs[i] = vmlog{log, removed}
	}
